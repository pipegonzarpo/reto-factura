...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { apellidos: @factura.apellidos, cedula: @factura.cedula, descuento: @factura.descuento, iva: @factura.iva, nombre: @factura.nombre, precio: @factura.precio, producto: @factura.producto }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { apellidos: @factura.apellidos, cedula: @factura.cedula, descuento: @factura.descuento, iva: @factura.iva, nombre: @factura.nombre, precio: @factura.precio, producto: @factura.producto }
    assert_redirected_to factura_path(assigns(:factura))
  end
